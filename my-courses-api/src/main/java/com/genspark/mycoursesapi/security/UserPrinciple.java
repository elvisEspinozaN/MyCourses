...
@NoArgsConstructor
@AllArgsConstructor
@Builder // produces code automatically
public class UserPrinciple implements UserDetails {
    // implement all abstract methods from User Details class
    private Long id;
    private String username;
    transient private String password; // transient :: won't show up on serialized places
